...
@Component("staffYuanzhangApprovalProcess")
public class StaffYuanzhangApprovalProcess implements RepairProcess 
{
	@Autowired
	...
	public String page() 
	{
		return "college/process/staffYuanzhangApprovalPage";
	}

	@Override
	public String list(Operator operator) 
	{
		return "b.belong_type = 2 ";
	}
