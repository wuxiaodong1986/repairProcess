...
<%@include file="../frame/menu.jsp" %>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">设备报修</strong> / <small><c:if test="${equipment.belong_type=='2'}">办公设备</c:if><c:if test="${equipment.belong_type=='3'}">教学设备</c:if></small></div>
    </div>

    <hr/>
    <form method="post" action="applyRepair.htm" id="updateform" class="am-form am-form-horizontal" data-am-validator>
    ...
    <div class="am-tabs am-margin" data-am-tabs>
      ...
      <div class="am-tabs-bd">
        ...
        <input type="hidden" name="status" value="<c:if test="${equipment.belong_type=='2'}">1</c:if><c:if test="${equipment.belong_type=='3'}">9</c:if>">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab3">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10 am-text-left">
              ${applicationScope.operatorMap[object.chuzhang].name}
            </div>
          </div>
