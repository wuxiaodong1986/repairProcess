...
<head>
  <meta charset="utf-8">
  <meta name="description" content="地址管理/地址列表">
...
<%@include file="../frame/menu.jsp" %>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">地址管理</strong> / <small>地址列表</small></div>
    </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-title" style="width: 20%;">地址</th>
                <th class="table-type">上级地址</th>
...
var listurl = "addressList.htm";
var updateurl = "preUpdateAddress.htm";
var delurl = "delAddress.htm";
...
function loadTbody(colobjects)
{
  for (var o in colobjects)
  {
    ...
    colobjecttr.append('<td>'+colobject['dscb']+'</td>');
