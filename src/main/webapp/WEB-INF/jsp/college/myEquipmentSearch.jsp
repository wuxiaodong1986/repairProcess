...
<head>
  <meta charset="utf-8">
  <meta name="description" content="设备管理/我的设备">
...
<%@include file="../frame/menu.jsp" %>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">设备管理</strong> / <small>我的设备</small></div>
    </div>
...
var listurl = "myEquipmentList.htm";
var updateurl = "preUpdateMyEquipment.htm";
var delurl = "delMyEquipment.htm";
