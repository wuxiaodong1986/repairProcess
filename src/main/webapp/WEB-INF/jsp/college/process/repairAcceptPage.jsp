...
<%@include file="../../frame/menu.jsp" %>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">设备报修</strong> / <small>接受报修</small></div>
    </div>
    ...
    <div class="am-margin">
      <button type="submit" class="am-btn am-btn-primary am-btn-xs">接受</button>
