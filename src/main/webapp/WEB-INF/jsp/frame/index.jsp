...
<head lang="en">
  ...
  <link rel="alternate icon" type="image/png" href="ui/amaze/i/favicon.png">
  <link rel="stylesheet" href="ui/amaze/css/amazeui.min.css"/>
  <style>
    .get {
      background: #1E5B94;
      color: #fff;
...
<header class="am-topbar am-topbar-fixed-top">
  <div class="am-container">
    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      ...
      <div class="am-topbar-right">
        <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="window.location='${url}/operatorLogin.htm'"><span class="am-icon-user"></span> 登录</button>
      </div>
    </div>
  </div>
</header>
...
<script src="../ui/amaze/js/polyfill/rem.min.js"></script>
<script src="../ui/amaze/js/polyfill/respond.min.js"></script>
<script src="../ui/amaze/js/amazeui.legacy.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="ui/amaze/js/jquery.min.js"></script>
<script src="ui/amaze/js/amazeui.min.js"></script>
<!--<![endif]-->
</body>
</html>